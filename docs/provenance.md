...
| [AttestoPhoenix public generated API docs](https://hexdocs.pm/attesto_phoenix/AttestoPhoenix.Config.html) | Host-provided optional package; fixture resolution `v2.13.0`; MIT | Public from-OTP-app validation and real core-config derivation compatibility gate; I01/I04 |
| [Igniter documentation](https://hexdocs.pm/igniter/readme.html) and released package | Optional `~> 0.6`; observed `v0.8.3`; MIT | Idempotent Phoenix host installer and in-memory installation tests; I01-I04 |
| [Phoenix Router public API](https://hexdocs.pm/phoenix/Phoenix.Router.html) and released package | Test-only `v1.7.24`; MIT | Compile-time verification that generated metadata and MCP forwards use distinct plug modules; I03-I04 |
