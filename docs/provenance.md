...
| [AttestoPhoenix public generated API docs](https://hexdocs.pm/attesto_phoenix/AttestoPhoenix.Config.html) | Host-provided optional package; fixture resolution `v2.14.1`; MIT | Public from-OTP-app validation, core-config derivation, CIMD, native-loopback, router integration, and combined-installer compatibility gates; I01/I04-I05 |
